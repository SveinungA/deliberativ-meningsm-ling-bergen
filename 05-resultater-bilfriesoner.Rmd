...
# Lag funksjon for øvre og nedre konfidensintervall
...
within_pre <- pre %>% 
  ...
  select(c(Q1, Q11, Q12, Q13, Q14, Q15, Q16, Q17_1, Q17_2, Q17_3, Q17_4, Q17_5, Q17_6, Q18, Q19, Q20, Q21)) 
  
within_post <- post_t %>% 
  filter(Q1 %in% post_t$Q1) %>% 
  select(c(Q1, Q11, Q12, Q13, Q14, Q15, Q16, Q17_1, Q17_2, Q17_3, Q17_4, Q17_5, Q17_6, Q18, Q19, Q20, Q21)) 
  
within <- full_join(within_post, within_pre, by = 'Q1', keep=TRUE) %>% filter(Q1.x == Q1.y)
within <- within %>% mutate(Q11_change = Q11.x - Q11.y,
                            Q12_change = Q12.x - Q12.y,
                            Q13_change = Q13.x - Q13.y,
                            Q14_change = Q14.x - Q14.y,
                            Q15_change = Q15.x - Q15.y,
                            Q16_change = Q16.x - Q16.y,
                            Q17_1_change = Q17_1.x - Q17_1.y,
                            Q17_2_change = Q17_2.x - Q17_2.y,
                            Q17_3_change = Q17_3.x - Q17_3.y,
                            Q17_4_change = Q17_4.x - Q17_5.y,
                            Q17_5_change = Q17_5.x - Q17_5.y,
                            Q17_6_change = Q17_6.x - Q17_6.y,
                            Q18_change = Q18.x - Q18.y,
                            Q19_change = Q19.x - Q19.y,
                            Q20_change = Q20.x - Q20.y,
                            Q21_change = Q21.x - Q21.y) %>% 
  select(ends_with("change"))

within_summary <- within %>% summarise(smean = across(c(Q11_change:Q21_change), ~ mean(.x, na.rm = TRUE)),
                                       sd = across(c(Q11_change:Q21_change), ~ sd(.x, na.rm = TRUE)),
                                       count = across(c(Q11_change:Q21_change), ~ n()))
```
...
```
> Merknad: Her bør vi vise resultatene på en måte som bedre får fram om respondentene beveger seg mot det beslutningsnivået som gir dem et "favorable outcome".
